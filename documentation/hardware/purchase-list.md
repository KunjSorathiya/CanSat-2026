...
| ~~0.1 µF 50 V ceramic, marked `104`~~ | — | **Received 2026-09-06, as ordered.** Six are fitted: microSD, RA-02, MPU-6500, BMP280, NEO-6M and the sound board. A seventh is reserved against the `GP26` measurement at step 14 and is not fitted on spec. Not optional and not substitutable — every bulk capacitor, of every type, is too slow for the fast edges these cover | — |
