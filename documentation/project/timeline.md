...
| Flight core | Controller, state machine, scheduler, orientation, calibration, faults, builder, block log, NMEA parser, link profile and airtime guard | 25 C++ suites, 324 assertions |
