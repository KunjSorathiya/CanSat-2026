...
| Scope | Status |
|---|---|
| Flight core logic, telemetry format, parser, framing, GPS parsing, fix ageing and validation, state machine, attitude fusion, calibration, radio airtime, sensor timing, packet-size degradation, log recovery | **Verified on host** — 100 C++ suites with 3962 assertions, plus the LoRa driver (101) and the microSD driver (581) against simulated devices, 167 Python tests including an end-to-end trace, and 59 Node tests |
