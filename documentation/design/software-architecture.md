...
| Scope | Status |
|---|---|
| Flight core logic, telemetry format, parser, framing, GPS parsing, fix ageing and validation, state machine, attitude fusion, calibration, radio airtime, sensor timing, packet-size degradation, log recovery | **Verified on host** — 59 C++ suites with 3560 assertions, plus the LoRa driver (94) and the microSD driver (581) against simulated devices, 147 Python tests including an end-to-end trace, and 49 Node tests |
