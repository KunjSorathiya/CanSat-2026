...
| Scope | Status |
|---|---|
| Flight core logic, telemetry format, parser, framing, GPS parsing, fix ageing and validation, state machine, attitude fusion, calibration, radio airtime, sensor timing, packet-size degradation, log recovery | **Verified on host** — 123 C++ suites with 4202 assertions, plus the LoRa driver (139) and the microSD driver (613) against simulated devices, 229 Python tests including an end-to-end trace, and 65 Node tests |
