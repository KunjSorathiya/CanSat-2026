...
| MEC-001 | The CanSat structure must fit the clarified size limit. | Rulebook - General Rules; conflicting pages | Mandatory | **Requirement locked: 21 cm (+7 cm egg chamber) × 12 cm**, stated identically on two pages of the 2026 revision. **The first real constraint is found and drawn:** a 100 × 100 mm board has a 141.4 mm diagonal and does not fit a 120 mm section laid flat; edge-on as a spine it does. No structure exists | Measure completed structure after organizer clarification. | **Requirement locked; nothing built** | [mechanical/README.md](../../mechanical/README.md); [envelope drawing](../../mechanical/drawings/envelope-and-board-fit.svg), generated from the requirement by `tools/gen_envelope_drawing.py` |
...
| MEC-006 | CAD documentation must represent the completed design. | Rulebook - Structure / Material Scoring | Scoring | No CAD exists. The constraints a model must satisfy are recorded so it can be started before anything else is decided | Compare CAD, drawings, and physical hardware. | Not Started | [mechanical/CAD/README.md](../../mechanical/CAD/README.md) |
