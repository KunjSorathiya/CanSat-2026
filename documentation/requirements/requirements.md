...
| MEC-001 | The CanSat structure must fit the clarified size limit. | Rulebook - General Rules; conflicting pages | Mandatory | **A design exists: `Cansat_D1`, 118.5 × 115.0 × 110.0 mm.** Height is inside the 210 mm body allowance with 91.5 mm to spare. **Across is the open part:** both faces are inside 120 mm, but the section diagonal is **159.1 mm**, so the answer depends on whether "12 cm across" is a width limit or a diameter — **+33 % under the second reading, against a 10 % disqualification threshold.** Nothing is fabricated | Measure the completed CanSat against 21/28 cm x 12 cm, once the organizers say how "across" is measured. | **Designed; the limit's meaning is open** (question 10) | [mechanical/README.md](../../mechanical/README.md#the-envelope-question--and-it-is-a-disqualification-class-one); dimensions read from the STEP by `tools/cad_dimensions.py` and held to this document by `check_doc_claims.py` |
| MEC-002 | The completed CanSat must fit the clarified mass limit. | Rulebook - Page 4 extract | Mandatory | **Requirement locked: 500 g ± 10 %.** A first-pass mass budget exists and puts the avionics at roughly 70 g, leaving ~380 g for the structure — so mass is very unlikely to be the binding constraint. **Nothing has been weighed**; every figure is a vendor number | Weigh complete flight configuration. | **Requirement locked; nothing weighed** | [mechanical/README.md](../../mechanical/README.md#mass-budget). The first action is a kitchen scale: the assembled board, the battery, and the perfboard offcut |
| MEC-003 | Internal layout must protect the payload and use size and mass efficiently. | Rulebook - Structure / Material Scoring | Scoring | **Layout is modelled, not yet justified.** The 115 × 110 mm section takes the 100 × 100 mm board flat, which the earlier circular-section reasoning said was impossible. **91.5 mm of the 210 mm height allowance is unused**, and section D scores effective use of the volume the rules permit — so that is a deliberate decision to make rather than an oversight to leave | Design review and measured completed assembly. | In Progress | [`CAD/Cansat_D1.step`](../../mechanical/CAD/Cansat_D1.step); [envelope drawing](../../mechanical/drawings/envelope-and-board-fit.svg) |
...
11. **How is the 12 cm "across" limit measured on a non-cylindrical CanSat?** The design is
    prismatic: 115 x 110 mm in section, so **both faces are inside 120 mm while the corner-
    to-corner diagonal is 159.1 mm**. Read as a width limit it passes; read as a diameter it
    is **33% over**, and exceeding a dimensional limit by more than 10% is a disqualification
    condition rather than a scored one. The vehicle is drone-released and never passes
    through a tube, which argues for the width reading - but the cost of being wrong is the
    whole flight, and the fallback is a structural redesign plus a board rebuild, since a
    120 mm bore caps a flat deck at 84.9 mm square. **Raised 2026-09-09**; see
    [mechanical/README.md](../../mechanical/README.md#the-envelope-question--and-it-is-a-disqualification-class-one).
