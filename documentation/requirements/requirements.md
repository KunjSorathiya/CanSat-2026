...
| TEL-001 | Telemetry must transmit continuously from power-on at the ground floor through recovery. | Rulebook - Telemetry | Mandatory | Onboard RA-02, ground RA-02, and firmware - TBD | End-to-end test from power-on through recovery. | Not Started | |
| TEL-002 | Telemetry must continue during lift to launch altitude. | Rulebook - Telemetry | Mandatory | Telemetry scheduler - TBD | Record packets throughout a lift test. | Not Started | |
| TEL-003 | Telemetry must continue throughout flight. | Rulebook - Telemetry | Mandatory | Telemetry scheduler and radio link - TBD | Review complete flight telemetry. | Not Started | |
| TEL-004 | Telemetry must continue after landing until recovery. | Rulebook - Telemetry | Mandatory | Post-landing radio behavior - TBD | Observe telemetry from impact until recovery. | Not Started | |
| TEL-005 | The minimum telemetry rate must be at least 1 packet per second. | Rulebook - Telemetry | Mandatory | Packet scheduler - TBD | Timestamp received packets and calculate rate and loss. | Not Started | |
| TEL-006 | Every packet must contain the correct team identifier. | Rulebook - Telemetry | Mandatory | Team identifier configuration - TBD | Inspect generated and received packets. | Not Started | |
| TEL-007 | Packet numbers must start at P-001. | Rulebook - Telemetry | Mandatory | Packet counter - TBD | Cold-start the CanSat and inspect the first packet. | Not Started | |
| TEL-008 | Packet numbers must increment sequentially. | Rulebook - Telemetry | Mandatory | Packet counter and reset behavior - TBD | Analyze a packet sequence for gaps and duplicates. | Not Started | |
| TEL-009 | Packets must use the exact required field order and delimiters. | Rulebook - Mandatory Packet Format | Mandatory | Packet formatter - TBD | Compare generated packets with the specified format. | Not Started | |
| TEL-010 | The team identifier field must use `CAN-Team-XX`. | Rulebook - Mandatory Packet Format | Mandatory | Team identifier field - TBD | Validate the field in recorded packets. | Not Started | |
| TEL-011 | The packet must include `Ti-HH:MM:SS:MS` timestamp data. | Rulebook - Mandatory Packet Format | Mandatory | Timestamp source and formatter - TBD | Inspect timestamp format and monotonic behavior. | Not Started | |
| TEL-012 | The packet must include altitude as `A-XXX.X` in metres with 1 decimal place. | Rulebook - Mandatory Packet Format | Mandatory | BMP280 altitude calculation and formatter - TBD | Validate field syntax, units, and precision. | Not Started | |
| TEL-013 | The packet must include pressure as `Pr-XXXX.XX` in Pa with 2 decimals. | Rulebook - Mandatory Packet Format | Mandatory | BMP280 pressure measurement and formatter - TBD | Validate field syntax, units, and precision. | Not Started | |
| TEL-014 | The packet must include temperature as `T-XX.X` in degrees C with 1 decimal place. | Rulebook - Mandatory Packet Format | Mandatory | BMP280 temperature measurement and formatter - TBD | Validate field syntax, units, and precision. | Not Started | |
| TEL-015 | The packet must include roll as `Ro-XX.X` in degrees with 1 decimal place. | Rulebook - Mandatory Packet Format | Mandatory | Orientation calculation - TBD | Validate field syntax, units, precision, and test orientation. | Not Started | |
| TEL-016 | The packet must include pitch as `Pi-XX.X` in degrees with 1 decimal place. | Rulebook - Mandatory Packet Format | Mandatory | Orientation calculation - TBD | Validate field syntax, units, precision, and test orientation. | Not Started | |
...
| TEL-018 | The packet must include X acceleration as `AX-XX.XX` in m/s2 with 2 decimals. | Rulebook - Mandatory Packet Format | Mandatory | MPU6050 X measurement and formatter - TBD | Validate field syntax, units, precision, and calibrated readings. | Not Started | |
| TEL-019 | The packet must include Y acceleration as `AY-XX.XX` in m/s2 with 2 decimals. | Rulebook - Mandatory Packet Format | Mandatory | MPU6050 Y measurement and formatter - TBD | Validate field syntax, units, precision, and calibrated readings. | Not Started | |
| TEL-020 | The packet must include Z acceleration as `AZ-XX.XX` in m/s2 with 2 decimals. | Rulebook - Mandatory Packet Format | Mandatory | MPU6050 Z measurement and formatter - TBD | Validate field syntax, units, precision, and calibrated readings. | Not Started | |
| TEL-021 | Missing or corrupted mandatory fields must not be accepted as telemetry points. | Rulebook - Telemetry | Mandatory | Packet validator - TBD | Inject malformed packets and confirm rejection. | Not Started | |
| TEL-022 | Optional sensor data may be appended only after mandatory data and must not displace it. | Rulebook - Telemetry | Recommended | GPS optional fields - TBD | Test packets with and without optional fields. | Not Started | |
| TEL-023 | Official launch LoRa sync word must be `0xA5`. | Rulebook - LoRa Configuration | Mandatory | RA-02 configuration - TBD | Inspect configuration and test against the official receiver. | Not Started | |
| TEL-024 | Pre-launch testing LoRa sync word must be `0xF3`. | Rulebook - LoRa Configuration | Mandatory | Separate test configuration - TBD | Test using `0xF3` and confirm isolation from launch mode. | Not Started | |
