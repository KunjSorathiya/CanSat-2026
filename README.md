...
[![C++ tests](https://img.shields.io/badge/C%2B%2B%20tests-1232%20assertions-1b5e20)](documentation/testing/test-plan.md)
...
| Layer | State |
|---|---|
| 🟢 **Software** | Flight core, telemetry protocol, ground station and web console **implemented and passing 1375 automated checks on the host**, including an end-to-end trace from the flight controller through the ground pipeline |
