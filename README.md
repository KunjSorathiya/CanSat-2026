...
[![C++ tests](https://img.shields.io/badge/C%2B%2B%20tests-1187%20assertions-1b5e20)](documentation/testing/test-plan.md)
...
| Layer | State |
|---|---|
| 🟢 **Software** | Flight core, telemetry protocol, ground station and web console **implemented and passing 1326 automated checks on the host**, including an end-to-end trace from the flight controller through the ground pipeline |
...
|---|---|---|
| `flight_tests` | 33 suites: packet format and edge cases, parser, shared protocol fixtures, state machine, orientation and angle wrapping, GPS validation, sensor math, IMU range encoding, sensor timing, calibration, faults, scheduler, block log, controller behaviour and packet-size degradation, link profile, LoRa airtime | ✅ **506 / 506** |
