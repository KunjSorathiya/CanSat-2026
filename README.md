...
[![C++ tests](https://img.shields.io/badge/C%2B%2B%20tests-4433%20assertions-1b5e20)](documentation/testing/test-plan.md)
...
| Web console (Node) | Framing, parser, validator, link health and bridge status, extracted from `index.html` | ✅ **59 / 59** |
