...
| 🟡 **Mechanical** | **Designed, simulated, and out for 3D printing in PETG.** `Cansat_D1` is **118.5 × 115.0 × 110.0 mm** — inside the height allowance with 91.5 mm spare and inside the 120 mm section with **2.5 and 5.0 mm of clearance per side**, the organizers having confirmed a 12 cm *sided box*. Three static-stress studies put peak von Mises at **1.33–2.885 MPa against a 54.40 MPa yield** — safety factors of 19 to 41, with [four caveats](mechanical/simulation/README.md). **Mass: 344.299 g committed** — electronics weighed at 151.299 g, PETG structure estimated at 193 g — and the projected all-up **414–479 g** now makes coming in *under* the 450 g floor the likelier risk. Parachute sized at **80.0 cm**. Still to do: **print it, weigh it, drop-test it** |
...
| Documented claims | Numbers in the documentation checked against the source that defines them — test counts, the generated netlist, and the descent model's canopy diameter included | ✅ **273 / 273** |
