...
[![C++ tests](https://img.shields.io/badge/C%2B%2B%20tests-1339%20assertions-1b5e20)](documentation/testing/test-plan.md)
...
| Python (ground station) | Parser, validator, transport, health, logging robustness, bridge status, vehicle-restart recovery, shared protocol fixtures, and a cross-language end-to-end trace of real vehicle output | ✅ **91 / 91** |
| Python (tooling) | LoRa airtime model, pinned to published SX127x reference vectors | ✅ **33 / 33** |
| Web console (Node) | Framing, parser, validator and link health, extracted from `index.html` | ✅ **34 / 34** |
