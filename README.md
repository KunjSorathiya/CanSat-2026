...
| 🟡 **Mechanical** | **Designed, simulated, and out for 3D printing in PETG.** `Cansat_D1` is **118.5 × 115.0 × 110.0 mm** — inside the 210 mm height with 91.5 mm spare, and inside the 120 mm section with **2.5 and 5.0 mm of clearance per side**, the organizers having confirmed a 12 cm *sided box* is acceptable. Three static-stress studies put peak von Mises at **1.33–2.885 MPa against a 54.40 MPa yield** — safety factors of 19 to 41, though [four caveats](mechanical/simulation/README.md) keep them honest. **The electronics are weighed for the first time: 151.299 g**, 30 % of the budget, leaving 348.7 g. The parachute is sized at **80.0 cm**. Still to do: **print it, weigh it, drop-test it** |
...
| Documented claims | Numbers in the documentation checked against the source that defines them — test counts, the generated netlist, and the descent model's canopy diameter included | ✅ **270 / 270** |
...
| Size and mass limits | **Size: designed and compliant** — 118.5 × 115.0 × 110.0 mm against 21 cm × a 12 cm sided box, confirmed with the organizers 2026-09-09. **Mass: the electronics are measured at 151.299 g**, 30 % of the 500 g budget; the PETG structure is neither printed nor weighed | 🟡 Size settled, mass part-measured |
